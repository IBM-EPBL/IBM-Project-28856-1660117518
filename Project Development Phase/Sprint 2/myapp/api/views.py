...
def register_user(request):
    ...
    # 
    # username,first_name,last_name,email,phone_number,password) values(%s,%s,%s,%s,%s,%s,%s)"%(user.id,user.username,user.first_name,user.last_name,user.email,user.phone_number,user.password)
